...
// 20250509 qmk docker compile how to
// cd qmk_firmware
// ./util/docker_cmd.sh
// qmk setup
// qmk hello
// qmk compile -kb keybordio/atreus -km 2025MMDD
...
//left right modkey
  [JBASE] = LAYOUT( /* Qwerty win jpkey */
    ...
    Z_SFT,     KC_X,     KC_C,     KC_V,     KC_B,    CM_ALT4, MO_SYS,   KC_N,      KC_M,     KC_COMM,  KC_DOT,  SL_SFT,
    CM_DLEF,   CM_DRHT,  KC_LGUI,  CM_SPFN,  CM_LISE, KC_LCTL, KC_LALT,  CM_SPFN,   KC_LSFT,  KC_LGUI,  KC_LALT, KC_DEL),
...
//**********************************************************
  ...
  [SPFN] = LAYOUT( /* [> SPFN <] */
    ...
    _______,   KC_LSFT,   KC_DEL,  MO_HYPS,   KC_LGUI,                    KC_BSPC,  KC_LEFT,  KC_DOWN,  KC_RGHT, KC_ENT,
