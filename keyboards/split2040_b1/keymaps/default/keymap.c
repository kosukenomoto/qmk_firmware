...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [JBASE] = LAYOUT_split_3x5_2(  /* Qwerty win jpkey */
    //win jpkey(QMK)  GUI(command)   CTL(control)   ALT(option)
        KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,           KC_Y,     KC_U,     KC_I,     KC_O,    KC_P,
        A_ALT,    KC_S,     KC_D,     F_CTL,    G_GUI,          H_GUI,    J_CTL,    KC_K,     KC_L,    SC_ALT,
        CM_SHTZ,  X_CTL,    KC_C,     KC_V,     KC_B,           KC_N,     KC_M,     KC_COMM,  DT_CTL,  CM_SJSS,
                                      CM_SPFN2, CM_LISE,        CM_SPFN,  CM_JFN  
    ),   

    [UBASE] = LAYOUT_split_3x5_2( /* Qwerty mac uskey */
    ...
    //mac karabiner(win)  option(ALT)->GUI  command(GUI)->control(CTL)  control(CTL)->option(ALT)                        
        KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,           KC_Y,     KC_U,     KC_I,     KC_O,    KC_P,
        A_ALT,    KC_S,     KC_D,     F_CTL,    G_GUI,          H_GUI,    J_CTL,    KC_K,     KC_L,    SC_ALT,
        CM_SHTZ,  X_CTL,    KC_C,     KC_V,     KC_B,           KC_N,     KC_M,     KC_COMM,  DT_CTL,  CM_SUSS,
                                      CM_SPFN2, CM_LISE,        CM_SPFN,  CM_UFN
    ),
    
    [JRISE] = LAYOUT_split_3x5_2( 
