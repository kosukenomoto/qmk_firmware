...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [JBASE] = LAYOUT_split_3x6_2(  /* Qwerty win jpkey */
    //win jpkey(QMK)  GUI(command)   CTL(control)   ALT(option)
        KC_LGUI,  KC_Q,    KC_W,    KC_E,     KC_R,    KC_T,          KC_Y,    KC_U,    KC_I,     KC_O,    KC_P,    JP_MINS,
        CM_SPFN2, A_ALT,   KC_S,    KC_D,     KC_F,    KC_G,          KC_H,    KC_J,    KC_K,     KC_L,    SC_ALT,  CM_RISE,
        KC_LSFT,  Z_SFT,   KC_X,    KC_C,     KC_V,    KC_B,          KC_N,    KC_M,    KC_COMM,  KC_DOT,  SL_SFT,  KC_LSFT,
                                    CM_LISE,  TAB_CTL,        CM_SPFN, CM_JFN
    ),   

    [UBASE] = LAYOUT_split_3x6_2( /* Qwerty mac uskey */
    ...
    //mac karabiner(win)  option(ALT)->GUI  command(GUI)->control(CTL)  control(CTL)->option(ALT)                        
        ...
        CM_SPFN2, A_ALT,   KC_S,    KC_D,     KC_F,    KC_G,          KC_H,    KC_J,    KC_K,     KC_L,    SC_ALT,  CM_RISE,
        KC_LSFT,  Z_SFT,   KC_X,    KC_C,     KC_V,    KC_B,          KC_N,    KC_M,    KC_COMM,  KC_DOT,  SL_SFT,  KC_LSFT,
                                    CM_LISE,  TAB_CTL,        CM_SPFN, CM_UFN
    ),
    
    [JRISE] = LAYOUT_split_3x6_2( 
        _______,  JP_EXLM,  JP_AT,    JP_HASH,  JP_DLR,   JP_PERC,        JP_AMPR,  JP_ASTR,  JP_LPRN,  JP_RPRN,  JP_MINS, _______, 
        _______,  JP_UNDS,  JP_PLUS,  JP_EQL,   JP_ASTR,  JP_CIRC,        JP_LCBR,  JP_RCBR,  JP_LBRC,  JP_RBRC,  JP_COLN, _______, 
        _______,  JP_BSLS,  JP_AMPR,  JP_PIPE,  JP_TILD,  JP_GRV,         JP_QUOT,  JP_DQUO,  JP_LABK,  JP_RABK,  JP_QUES, _______,  
                                      _______,  _______,        KC_LCTL,  KC_LALT 
    ),

    [URISE] = LAYOUT_split_3x6_2( 
        _______,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,        KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_MINS, _______, 
        _______,  KC_UNDS,  KC_PLUS,  KC_EQL,   KC_ASTR,  KC_CIRC,        KC_LCBR,  KC_RCBR,  KC_LBRC,  KC_RBRC,  KC_COLN, _______, 
        _______,  KC_BSLS,  KC_AMPR,  KC_PIPE,  KC_TILD,  KC_GRV,         KC_QUOT,  KC_DQUO,  KC_LABK,  KC_RABK,  KC_QUES, _______,  
                                      _______,  _______,        KC_LCTL,  KC_LALT 
    ),

    [JSPFN] = LAYOUT_split_3x6_2( /* [> SPFN <] */
        _______,  CM_GUIE,  CM_ALT4,  LT_JLEF,  CM_GUIT,  CM_WSCS,        _______,  KC_HOME,  KC_UP,    KC_END,   JP_MINS, _______, 
        _______,  KC_LALT,  KC_LSFT,  KC_DEL,   MO_HYPS,  KC_LGUI,        KC_BSPC,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_ENT,  _______,
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,           KC_6,     KC_7,     KC_8,     KC_9,     KC_0,    _______,
                                      KC_LALT,  KC_LCTL,        _______,  _______  
    ),

    [USPFN] = LAYOUT_split_3x6_2( /* [> SPFN <] */
        _______,  CM_GUIE,  CM_ALT4,  LT_ULEF,  CM_GUIT,  CM_WSCS,        _______,  KC_HOME,  KC_UP,    KC_END,   KC_MINS, _______, 
        _______,  KC_LALT,  KC_LSFT,  KC_DEL,   MO_HYPS,  KC_LGUI,        KC_BSPC,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_ENT,  _______,
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,           KC_6,     KC_7,     KC_8,     KC_9,     KC_0,    _______,
                                      KC_LALT,  KC_LCTL,        _______,  _______  
    ), 

    [JLEF] = LAYOUT_split_3x6_2( 
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  CM_CHOM,  KC_PGUP,  CM_CEND,  _______, _______, 
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  CM_CPGU,  KC_PGDN,  CM_CPGD,  _______, _______,
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  _______,  _______,  _______,  _______, _______,
                                      _______,  _______,        _______,  _______  
    ),

    [ULEF] = LAYOUT_split_3x6_2( 
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  CM_CHOM,  KC_PGUP,  CM_CEND,  _______, _______, 
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  CM_CPGU,  KC_PGDN,  CM_CPGD,  _______, _______,
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  _______,  _______,  _______,  _______, _______,
                                      _______,  _______,        _______,  _______  
    ...
    [HYPSPFN] = LAYOUT_split_3x6_2( 
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  _______,  CM_UP,    _______,  _______, _______, 
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  CM_LEFT,  CM_DOWN,  CM_RGHT,  _______, _______,
        _______,  _______,  _______,  _______,  _______,  _______,        _______,  _______,  _______,  _______,  _______, _______,
                                      _______,  _______,        _______,  _______  
    ),
    
    [JFN] = LAYOUT_split_3x6_2(
        _______,  _______,  _______,  _______,  _______,  _______,        DF_UBAS,  _______,  _______,  _______,  _______, QK_BOOT, 
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,          _______,  KC_BTN1,  CM_SF10,  _______,  KC_LSFT, _______,
        _______,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,         KC_F11,   KC_F12,   _______,  _______,  _______, _______,
                                      KC_LALT,  KC_LCTL,        _______,  _______  
    ),

    [UFN] = LAYOUT_split_3x6_2( 
        _______,  _______,  _______,  _______,  _______,  _______,        DF_UBAS,  _______,  _______,  _______,  _______, QK_BOOT, 
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,          _______,  KC_BTN1,  CM_SF10,  _______,  KC_LSFT, _______,
        _______,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,         KC_F11,   KC_F12,   _______,  _______,  _______, _______,
                                      KC_LALT,  KC_LCTL,        _______,  _______  
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case CM_RISE:
      if (get_highest_layer(default_layer_state)==JBASE){
        user_lt(record,JRISE,KC_SLSH,&lise_pressed,&lise_pressed_time,false);
      } else {
        user_lt(record,URISE,KC_SLSH,&lise_pressed,&lise_pressed_time,false);
      }
      return false;
      break;
    case CM_LISE:
      if (get_highest_layer(default_layer_state)==JBASE){
        user_lt_hnzn(record,JRISE,&lise_pressed,&lise_pressed_time,false);
      } else {
        user_lt_hnzn(record,URISE,&lise_pressed,&lise_pressed_time,false);
      }
      return false;
      break;
    case CM_HZCL:
